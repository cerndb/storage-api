# -*- coding: utf-8 -*-
#
# CERN Unified Storage API documentation build configuration file, created by
...
project = u'CERN Unified Storage API'
...
#
# html_title = u'CERN Unified Storage API v1.0.0'
...
htmlhelp_basename = 'CERNUnifiedStorageAPIdoc'
